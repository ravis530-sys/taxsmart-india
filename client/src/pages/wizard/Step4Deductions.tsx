    ...
    >
      ...
      <div className="mb-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4">
          <InputField label="EPF Employee Contribution" prefix="₹" type="number" value={d80c.epfEmployee || ''} onChange={(e) => patch80C({ epfEmployee: +e.target.value })} />
      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4">
          ...
          <InputField label="Employer NPS 80CCD(2)" prefix="₹" type="number" value={other.npsEmployerContribution || ''} onChange={(e) => patchOther({ npsEmployerContribution: +e.target.value })} hint="Available in new regime too" />
          <InputField label="Health Insurance – Self &amp; Family" prefix="₹" type="number" value={other.healthInsuranceSelf || ''} onChange={(e) => patchOther({ healthInsuranceSelf: +e.target.value })} hint="80D – max ₹25K (₹50K if senior)" />
          <InputField label="Health Insurance – Parents" prefix="₹" type="number" value={other.healthInsuranceParents || ''} onChange={(e) => patchOther({ healthInsuranceParents: +e.target.value })} hint="Extra ₹25K/₹50K for parents" />
